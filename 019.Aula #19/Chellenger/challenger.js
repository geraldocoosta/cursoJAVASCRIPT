(function(){
	...
	*/
	...
	var testes = [ "container", "text", "date", "excerpt" ,"main"]

	testes.forEach(function(item){
		console.log(hasClass(markup, item) + ' para a classe ' + item);
	});


// só pra gravar isso que é mt bom
// pelo /1 /2 /3 nós podemos referenciar alguma captura especifica entre (), bem nice
})();