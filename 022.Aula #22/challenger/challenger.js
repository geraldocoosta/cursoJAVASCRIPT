(function(window,document){
	...
	/*
		...
		*/
		var pessoa1 = {name:"Gege", lastName:"Costa"};
		var pessoa2 = {name:"Tete", lastName:"Silva"};
		...
		*/
		var sum = function sum(){
			return Array.prototype.reduce.call(arguments,function(sum, actual){
				return (+sum) + (+actual);
			});
		}
		...
		*/
		...
		console.log(sum(45,56,85,25,25,25,65));
		...
		*/
		...
		var justNumbers = function justNumbers(entry){
			return entry.split(/\D+/g);
		}
